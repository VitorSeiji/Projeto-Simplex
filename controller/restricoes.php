...
class restricoes
{
	...
	public function __construct() {
		...
		{ 
			$conteudo.='<input type="number" step="1" name="z'.$i.'" size="3" maxlength="4"> X<sub>'.$i.'</sub>';
		...
		{ 
			...
			{ 
				...
				$conteudo.='<input type="number" step="1" name="r'.$l.'_'.$c.'" size="3" maxlength="4"> X<sub>'.$c.'</sub>';
		...
		$conteudo.='<div class="container padding5">';//espaçamento
		...
		$conteudo.=$funcao;
		$conteudo.='<br><br>';
		$conteudo.='<button id="submit" name="submit" class="btn btn-success">Enviar</button>';
		$conteudo.='</form>';
